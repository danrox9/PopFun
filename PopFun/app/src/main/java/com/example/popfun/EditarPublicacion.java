    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String titulo = tituloE.getText().toString();
                String descripcion = descripcionE.getText().toString();
                if(TextUtils.isEmpty(titulo) || TextUtils.isEmpty(descripcion)){
                    Toast.makeText(EditarPublicacion.this, "El titulo o la descripción estan vacios, rellenalos", Toast.LENGTH_SHORT).show();
                }else{
